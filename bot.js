    ...
    if (message.content.startsWith(`${prefix}`)) {
        ...
        switch (cmd[0]) {
            ...
            case "h":
                switch (cmd[1]) {
                    case "dj":
                        message.author.send("Affiche les infos sur un donjon spécifique, utilisez ``" + `${prefix}dj <nom du donjon>` + "`` ou ``" + `${prefix}dj list` + "``" + " pour avoir la liste des donjons disponibles");
                        break;

                    default:
                        embed = {
                            "title": "Liste des commandes",
                            "description": "Vous pouvez faire ``" + `${prefix}help <commande>` + "`` ou ``" + `${prefix}h <commande>` + "`` pour avoir des infos complémentaires sur la commande",
                            "color": "#00FFFF",
                            "fields": [
                                {
                                    "name": '\u200B',
            ...
            case "dj":
                if (cmd[1] == "list") {
                    embed = new Discord.MessageEmbed()
                        ...
                        .setDescription("Tapez ``" + `${prefix}dj <nom du donjon>` + "`` pour avoir toutes les infos sur le donjon demandé")
                        .setColor("#00FFFF")
                        .addField('\u200B', "**Niveau 3**", false);
                    for (let i = 0; i < dj.length; i++) {
                        if (dj[i].level == "3") {
                            embed.addField("``" + `${dj[i].cmd}` + "``", `${dj[i].full_name}`, true);
                        }
                    }
                        ...
                        if (cmd[1] == dj[i].cmd) {
                            ...
                            embed = new Discord.MessageEmbed()
                                ...
                                .addFields(
                                    ...
                                    { name: '\u200B', value: '\u200B' },
                                    { name: "**Relique**", value: `${dj[id].relic}`, inline: true },
                    ...
                    if (id == undefined) {
                        ...
                        message.author.send("Tapez ``" + `${prefix}dj list` + "`` pour avoir la liste des donjons disponibles");
                    }
                    id = undefined;
                }
                break;
            ...
            default:
                ...
                message.author.send("Tapez ``" + `${prefix}help` + "`` ou ``" + `${prefix}h` + "`` pour voir la liste des commandes disponibles");
        }
        message.react('✅');
    }
})
